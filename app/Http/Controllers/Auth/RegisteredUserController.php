    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($request->role === 'umum') {
            $rules = array_merge($rules, [
                ...
                'nomor_kartu_identitas' => ['required', 'string', 'unique:user_umums,nomor_kartu_identitas'],
                'alamat' => ['required', 'string'],
                'nomor_whatsapp' => ['required', 'string', 'unique:user_umums,nomor_whatsapp'],
            ...
            $rules = array_merge($rules, [
                ...
                'tanggal_lahir' => ['required', 'date'],
                'kartu_identitas' => ['required', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:2048'],
                'nomor_kartu_identitas' => ['required', 'string', 'unique:user_pelajars,nomor_kartu_identitas'],
                'alamat' => ['required', 'string'],
                'nomor_whatsapp' => ['required', 'string', 'unique:user_pelajars,nomor_whatsapp'],
                'jenis_keperluan' => ['required', 'string', 'max:255'],
                'judul_keperluan' => ['required', 'string', 'max:255'],
            ]);
            ...
            $rules = array_merge($rules, [
                ...
                'tanggal_lahir' => ['required', 'date'],
                'kartu_identitas' => ['required', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:2048'],
                'nomor_kartu_identitas' => ['required', 'string', 'unique:user_instansis,nomor_kartu_identitas'],
                'alamat' => ['required', 'string'],
                'nomor_whatsapp' => ['required', 'string', 'unique:user_instansis,nomor_whatsapp'],
                'jenis_keperluan' => ['required', 'string', 'max:255'],
                'judul_keperluan' => ['required', 'string', 'max:255'],
            ]);
        } else {
